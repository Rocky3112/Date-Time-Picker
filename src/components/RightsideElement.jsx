    ...
    return (
        <div>
            ...
            <div className='pb-5'>
                ...
                <div className='flex items-center gap-3'>
                    <p className='p-3 rounded text-green-500 bg-gray-300 text-2xl'><RiCalendar2Fill /></p>
                ...
                <div className='flex items-center gap-3'>
                    <p className='p-3 rounded text-green-500 bg-gray-300 text-2xl'><MdOutlineWatchLater /></p>
                ...
                <div className='flex items-center gap-3 pt-3'>
                    <p className='p-3 rounded text-green-500 bg-gray-300 text-2xl'><MdOutlineAccessAlarm /></p>
